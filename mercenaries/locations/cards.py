...
class CardLocation(NamedTuple):
  ...
  def is_missed(self, game):
    if self.rank == 1 or self.mission == 'A1':
      # The 2 of Clubs is always verified during the tutorial mission "Ante Up",
      # and the Aces are never missable.
      return False

    return (
      not self.is_checked(game)
      and game.latest_chapter > self.min_chapter
    )
...
# Fields are: id, initial chapter, rank, suit, associated mission if any
CARDS = {
  card.short_name(): card
  for card in [
    # Chapter 1: Clubs
    # Missions without hints: M3 K3 A3
    mkcard( 2, 'clubs', 0, None, 'A1'),
    mkcard( 3, 'clubs', 1, 'C1'),
    mkcard( 4, 'clubs', 1, 'M1'),
    mkcard( 5, 'clubs', 1, 'K1'),
    mkcard( 6, 'clubs', 1, 'K2'),
    ...
    mkcard( 8, 'clubs', 1, 'C2'),
    mkcard( 9, 'clubs', 1, 'C3'),
    mkcard(10, 'clubs', 1, 'A2'),
    mkcard(11, 'clubs', 1, None, 'M3'),
    mkcard(12, 'clubs', 1, None, 'C3'),
    mkcard(13, 'clubs', 1, None, 'K3'),
    mkcard( 1, 'clubs', 1, None, 'A3'),

    # Chapter 2: Diamonds
    # Missions without hints: C6 M6 A6
    mkcard( 2, 'diamonds', 2, 'C4'),
    mkcard( 3, 'diamonds', 2, 'M4'),
    mkcard( 4, 'diamonds', 2, 'K4'),
    mkcard( 5, 'diamonds', 2, 'K5'),
    mkcard( 6, 'diamonds', 2, 'M5'),
    mkcard( 7, 'diamonds', 2, 'C5'),
    mkcard( 8, 'diamonds', 2, 'A4'),
    mkcard( 9, 'diamonds', 2, 'A5'),
    mkcard(10, 'diamonds', 2, 'K6'),
    mkcard(11, 'diamonds', 2, None, 'K6'),
    mkcard(12, 'diamonds', 2, None, 'M6'),
    mkcard(13, 'diamonds', 2, None, 'C6'),
    mkcard( 1, 'diamonds', 2, None, 'A6'),

    # Chapter 3: Hearts
    # Missions without hints: M9 K9 A9
    mkcard( 2, 'hearts', 3, 'M7'),
    mkcard( 3, 'hearts', 3, 'K7'),
    mkcard( 4, 'hearts', 3, 'C7'),
    mkcard( 5, 'hearts', 3, 'C8'),
    mkcard( 6, 'hearts', 3, 'K8'),
    mkcard( 7, 'hearts', 3, 'M8'),
    mkcard( 8, 'hearts', 3, 'A7'),
    mkcard( 9, 'hearts', 3, 'C9'),
    mkcard(10, 'hearts', 3, 'A8'),
    mkcard(11, 'hearts', 3, None, 'C9'),
    mkcard(12, 'hearts', 3, None, 'K9'),
    mkcard(13, 'hearts', 3, None, 'M9'),
    mkcard( 1, 'hearts', 3, None, 'A9'),

    # Chapter 4: Spades
    # Missions without hints: M12 A11
    mkcard( 2, 'spades', 4, 'K10'),
    mkcard( 3, 'spades', 4, 'C10'),
    mkcard( 4, 'spades', 4, 'M10'),
    mkcard( 5, 'spades', 4, 'M11'),
    mkcard( 6, 'spades', 4, 'C11'),
    mkcard( 7, 'spades', 4, 'K11'),
    mkcard( 8, 'spades', 4, 'A10'),
    mkcard( 9, 'spades', 4, 'C12'),
    mkcard(10, 'spades', 4, 'K12'),
    mkcard(11, 'spades', 4, None, 'M12'),
    mkcard(12, 'spades', 4, None, 'C12'),
    mkcard(13, 'spades', 4, None, 'K12'),
    mkcard( 1, 'spades', 4, None, 'A11'),
  ]
}
